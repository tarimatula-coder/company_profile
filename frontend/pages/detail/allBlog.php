...
// Query blog dengan pencarian
$qBlog = "SELECT * FROM blogs";
if (!empty($keyword)) {
    $qBlog .= " WHERE title LIKE '%$keyword%' OR content LIKE '%$keyword%'";
}
...
<body>
    <section id="blog">
        <div class="container">
            ...
            <div class="row mb-4">
                <div class="col-12 text-center">
                    ...
                    <p class="mx-auto" style="max-width: 600px;">
                        Berikut ini adalah artikel/blog yang ada di SMKN 1 Bangsri.
                    </p>
                </div>
            </div>
            ...
            <div class="row mb-4">
                <div class="col-md-6 offset-md-3">
                    <form method="GET" action="" class="d-flex">
                        <input type="text" name="search" class="form-control me-2" placeholder="Cari blog..."
            ...
            <div class="row text-center g-4">
                <?php if ($resultBlog->num_rows > 0): ?>
                    <?php while ($item = $resultBlog->fetch_object()) : ?>
                        <div class="col-md-4">
                            <a href="blog.php?id=<?= $item->id ?>" class="blog-post-link">
                                <article class="blog-post">
                                    ...
                                    <div class="content">
                                        ...
                                        <h5><?= htmlspecialchars(substr($item->title, 0, 100)) ?></h5>
                ...
                <?php else: ?>
                    <div class="col-12">
                        <p class="text-muted">Tidak ada data blog ditemukan.</p>
                    </div>
                <?php endif; ?>

                <!-- Tombol Kembali -->
                <div class="col-12 mt-2">
                    <a href="../../index.php#blog" class="mt-4">
    ...
    <style>
        ...
        .blog-post-link:hover .content h5,
        .blog-post-link:active .content h5 {
            color: #E74C3C;
        }
    </style>
